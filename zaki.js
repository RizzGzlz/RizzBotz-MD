        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            break
                    case 'bug': case 'report': {
                    	...
                    	zaki.sendMessage(`6285624399386@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedFooterText: `ʀɪᴢᴢ ᴊɪɢᴜᴍɪɴᴀ | © 2022`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'YouTube',
                                    url: 'https://youtube.com/channel/UCZRbc5WgB2LZz7-aaT2VuYg'
                                }
                            }, {
                            	urlButton: {
                                displayText: 'instagram',
                                    url: 'https://instagram.com/todayis_rizz\n'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Menu',
...
//━━━━━━━━━━━━━━━[ MENU LOC ]━━━━━━━━━━━━━━━\\
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: anu.trim(), locationMessage: { jpegThumbnail: fs.readFileSync('./media/menu.jpg') }, hydratedFooterText: `Jangan Spam Bot Jika Tidak Ingin Di Banned!`, hydratedButtons: [{ urlButton: { displayText: 'YouTube', url: 'https://youtube.com/channel/UCZRbc5WgB2LZz7-aaT2VuYg'} }, { urlButton: { displayText: 'instagram', url: 'https://instagram.com/todayis_rizz\n'} }, { quickReplyButton: { displayText: 'Owner', id: 'owner', } }, { quickReplyButton: { displayText: 'Donate', id: 'donate', } }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
...
case 'owner': case 'creator': {
    ...
    + 'FN:KiZakiXD\n'
    + 'ORG:ʀɪᴢᴢ ᴊɪɢᴜᴍɪɴᴀ;\n' //Nama Kalian
    + 'item1.TEL;type=CELL;type=VOICE;waid=6285624399386:+62 856-2439-9386\n' //Nomor Kalian
    + 'item1.X-ABLabel:ＲｉｚｚＢｏｔｚ\n' //Info Kalian
